                ...
                <?php 
			  	if($fetch_data['clearance'] != 'no_pdf.png') {
			    	...
			    	if($fetch_data['clearance_status'] == 0) {
			    		echo '<div class="btn-group btn-group-toggle" data-toggle="buttons">';
			    		echo '<a href="'.base_url('admin/confirm_clearance/'.$fetch_data['username'].'').'" class="btn btn-success"><i class="fas fa-check"></i></a>';
			    		echo '<a href="'.base_url('admin/decline_clearance/'.$fetch_data['username'].'').'" class="btn btn-danger"><i class="fas fa-times"></i></a>';
			    		echo '</div>';
			    	}
			    	else{
			    		echo 'Status: Approved';
